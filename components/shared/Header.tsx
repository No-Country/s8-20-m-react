...
const Header = () => {
  ...
  return (
    <nav className="relative z-50 flex flex-wrap items-center justify-between px-2 py-3 bg-headerBg mb-3 shadow-[0px_6px_10px_4px_rgba(0,0,0,0.05),0px_2px_3px_rgba(0,0,0,0.04)]">
